package com.gotchai.presentation.advice

import com.gotchai.presentation.support.error.ErrorResponse
import com.gotchai.presentation.support.response.ApiResponse
...
class ApiExceptionAdvice : ResponseEntityExceptionHandler() {
    ...
    fun handleCustomException(e: ErrorException): ResponseEntity<ApiResponse<ErrorResponse>> {
        log.error("gotchai CustomException : {}", e.message, e)
    ...
    protected fun handleException(e: Exception): ResponseEntity<ApiResponse<ErrorResponse>> {
        ...
        val errorResponse = ErrorResponse.of(internalServerError.name, internalServerError.message)
